                ...
                <div class="p-6 text-gray-900">
                    ...
                    @csrf
                        <div>
                            ...
                            <div class="my-3">
                                <textarea  placeholder="content" class="border-gray-300 shadow-sm w-1/2 rounded-lg" name="text" id="text">{{ old(key: 'text') }}</textarea>
                            @error('text')
                                <p class="text-red-400 font-medium">{{ $message }}</p>
                            @enderror
                            </div>
                            ...
                            <div class="my-3">
                            <input value="{{ old('author') }}" name="author" placeholder="Enter auther" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                            @error('author')
                                <p class="text-red-400 font-medium">{{ $message }}</p>
                            @enderror
                            </div>
